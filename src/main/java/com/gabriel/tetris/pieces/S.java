...
public class S extends Piece{
    ...
    public void loadShapesOnPiece() {
        ...
        pieceShapeListT0.add(new Shape(0,2));
    ...
    private void setCoords3(){
        positionXLeftLimit = 0;
        positionXRightLimit = Board.BOARD_WIDTH - 2;
        positionYBottomLimit = 17;
    }
